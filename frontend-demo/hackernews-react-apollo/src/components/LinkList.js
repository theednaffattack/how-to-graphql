...
export default graphql(ALL_LINKS_QUERY, {
  ...
  options: ownProps => {
    ...
    const isNewPage = ownProps.location.pathname.includes("new"); // eslint-disable-next-line
    const skip = isNewPage ? (page - 1) * LINKS_PER_PAGE : 0; // eslint-disable-next-line
    const first = isNewPage ? LINKS_PER_PAGE : 100; // eslint-disable-next-line
    const orderBy = isNewPage ? "createdAt_DESC" : null;
    return {
